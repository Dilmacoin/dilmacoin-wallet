...
import com.google.dilmacoin.core.AddressFormatException;
import com.google.dilmacoin.core.Base58;
import com.google.dilmacoin.core.DumpedPrivateKey;
import com.google.dilmacoin.core.ECKey;
import com.google.dilmacoin.core.ProtocolException;
import com.google.dilmacoin.core.Transaction;
import com.google.dilmacoin.protocols.payments.PaymentRequestException;
import com.google.dilmacoin.protocols.payments.PaymentRequestException.PkiVerificationException;
import com.google.dilmacoin.protocols.payments.PaymentSession;
import com.google.dilmacoin.protocols.payments.PaymentSession.PkiVerificationData;
import com.google.dilmacoin.script.Script;
import com.google.dilmacoin.uri.BitcoinURI;
import com.google.dilmacoin.uri.BitcoinURIParseException;
	...
	public abstract static class StringInputParser extends InputParser
	{
		...
		public void parse()
		{
			...
			if (input.startsWith("dilmacoin:"))
			{
				...
				{
					log.info("got invalid dilmacoin uri: '" + input + "'", x);
