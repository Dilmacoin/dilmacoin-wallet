...
import com.google.dilmacoin.net.discovery.*;
import com.google.dilmacoin.store.BlockStore;
...
import com.google.dilmacoin.core.AbstractPeerEventListener;
import com.google.dilmacoin.core.Address;
import com.google.dilmacoin.core.Block;
import com.google.dilmacoin.core.BlockChain;
import com.google.dilmacoin.core.CheckpointManager;
import com.google.dilmacoin.core.Peer;
import com.google.dilmacoin.core.PeerEventListener;
import com.google.dilmacoin.core.PeerGroup;
import com.google.dilmacoin.core.ScriptException;
import com.google.dilmacoin.core.Sha256Hash;
import com.google.dilmacoin.core.StoredBlock;
import com.google.dilmacoin.core.Transaction;
import com.google.dilmacoin.core.TransactionConfidence.ConfidenceType;
import com.google.dilmacoin.core.Wallet;
import com.google.dilmacoin.core.Wallet.BalanceType;
import com.google.dilmacoin.core.WalletEventListener;
import com.google.dilmacoin.store.BlockStoreException;
import com.google.dilmacoin.store.SPVBlockStore;
import com.google.dilmacoin.utils.Threading;
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
				...
				peerGroup.addPeerDiscovery(new PeerDiscovery()
				{
                    ...
                    String channel = "#dilmacoin" + String.format("%02d", i);
